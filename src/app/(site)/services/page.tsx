      ...
      <header className="relative">
        <div className="rounded-3xl glass-deep ring-1 ring-white/40 p-6 md:p-8">
          ...
          <p className="mt-3 text-slate-700 max-w-3xl">
            ให้คำปรึกษาและว่าความอย่างมืออาชีพ ครอบคลุมคดีแพ่ง อาญา ครอบครัว ผู้บริโภค แรงงาน บังคับคดี คดีปกครอง เป็นทนายความให้ผู้ต้องหาในชั้นสอบสวน ประกันตัวผู้ต้องหาหรือจำเลย ในคดีอาญา เจรจาไกล่เกลี่ย ประนอมข้อพิพาท ดำเนินคดีในชั้นสอบสวนศาลชั้นต้น ศาลอุทธรณ์ และศาลฎีกา
          </p>
